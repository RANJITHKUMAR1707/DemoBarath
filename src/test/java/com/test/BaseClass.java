...
public class BaseClass extends Browser {
	...
	/**
	 * select the drop down using visible text
	 * @param element given the webelement
	 * @param Text value that is going to select;
	 */
	public static void selectbyvisibletext(WebElement element,String Text) {
		Visiblityofelementsexplicitwait(element, 20);
 ...
 */
	...
	public static void verifyisdisplay(WebElement element) {
		...
		asserttrue(isdisplay(element));

	}
	/**
	 * verify the all list of element's are display
	 * @param element
	 */
	...
	/**
	 * verify the title with expected title
	 * @param ExpectedTitle
	 */
	public static void verifytitle(String ExpectedTitle) {
		assertEquals(GetTitle(),ExpectedTitle);
		Extentlogger.info("The Current page title is "+GetTitle());
	}
	/**
	...
	/**
	 * Explicit wait for Visiblity of element 
	 */
	public static void Visiblityofelementsexplicitwait(WebElement element,int seconds) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(seconds));
